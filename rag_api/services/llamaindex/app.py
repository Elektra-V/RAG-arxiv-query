...
def create_app() -> FastAPI:
    ...
    configure_logging()
    api = FastAPI(
        title="RAG LlamaIndex Service",
        description="RAG API with LlamaIndex and enhanced debugging",
        version="0.1.0",
    )
    ...
    async def root():
        ...
        <html>
        <head>
            <title>RAG API - LlamaIndex Debug UI</title>
            <style>
        ...
        <body>
            <div class="container">
                <h1>🔍 RAG API - LlamaIndex Debug Interface</h1>
                <div class="links">
                ...
                <form id="queryForm">
                    ...
                    <div class="form-group">
                        <label for="topk">Similarity Top K:</label>
                ...
                fetch('/status')
                    ...
                    .then(data => {
                        ...
                        statusDiv.innerHTML = `<strong>Status:</strong> ${data.status.toUpperCase()} | 
                            LLM: ${data.configuration.llm_provider} | 
                            Embeddings: ${data.configuration.embedding_provider}`;
                    });
                ...
                document.getElementById('queryForm').addEventListener('submit', async (e) => {
                    ...
                    try {
                        const response = await fetch('/query', {
                            ...
                            body: JSON.stringify({ question, debug, similarity_top_k: topk })
                        });
